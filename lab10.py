...
def make_move(move):
    ...
    if winner(board, player):
        highlight_winning_combination(player, 'DarkOliveGreen3')
        ...
        if computer_move is not None:
            ...
            if winner(board, computer):
                highlight_winning_combination(computer, 'IndianRed1')
...
for i in range(9):
    button = tk.Button(root, text=' ', bg='bisque3', font=('Arial', 20), width=4, height=2, command=lambda move=i: make_move(move))
